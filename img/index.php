<?php
   ...
   $messaggio="";
   if(isset($_SESSION['messaggioCreazioneAula']))
   {
    $messaggio=$_SESSION['messaggioCreazioneAula'];
...
<head>
  ...
  <script src="mostra_immagine.js?v1"></script>
</head>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Aggiungi aula</h1>
          </div>

          <div class="container card" style="padding-top:15px; padding-bottom:15px;">
            <form action="carica.php" method="post" multipart="" enctype="multipart/form-data">
              <div class="form-group">
                  <label for="nome">Nome Aula</label>
                  <input type="text" class="form-control" name="nome" id="nome" placeholder="Inserisci il nome dell'aula" required>
                </div>
                <div class="form-group">
                  <label for="desc">Descrizione</label>
                  <textarea type="text" class="form-control" id="desc" name="desc" placeholder="Inserisci una breve descrizione (es. Il materiale presente)" required></textarea>
                </div>
                <div class="form-group">
                  <label for="numero">Numero Posti</label>
                  <input type="text" class="form-control" id="numero" name="numero" placeholder="Inserisci il numero di posti disponibili" required>
                </div>
                <div class="form-group">
                  <label for="note">Note</label>
                  <input type="text" class="form-control" id="note" placeholder="Inserisci eventuali note" name="note">
                </div>
                <div class="form-group">
                  <label for="file">Carica il file</label>
                  <input type="file" class="form-control" id="file" name="file[]" multiple required style="padding:3px;"/>
                </div>
                <center><button class="btn btn-primary" type="submit">Carica</button></center>
                <center style="padding: 20px"><?=$messaggio?></center>
            </form>
          </div>
